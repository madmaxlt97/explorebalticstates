...
export const lithuaniaCities: City[] = [
  ...
  },
  {
    ...
    topics: [
      {
        id: "kaunas-airport",
        title: "Best way to get from airport to Kaunas center",
        cardImage: "/assets/images/topics-images/airport-topic-img.jpg",
      },
      {
        id: "kaunas-hotels",
        title: "Best areas to stay in Kaunas",
        cardImage: "/assets/images/topics-images/hotel-topic-img.jpg",
      },
      {
        id: "kaunas-cuisine",
  ...
  },
  {
    ...
    topics: [
      {
        id: "klaipeda-airport",
        title: "Best way to get from airport to Klaipėda center",
        cardImage: "/assets/images/topics-images/airport-topic-img.jpg",
      },
      {
        id: "klaipeda-hotels",
        title: "Best areas to stay in Klaipėda",
        cardImage: "/assets/images/topics-images/hotel-topic-img.jpg",
      },
      {
        id: "klaipeda-cuisine",
        title: "Best places to try national cuisine in Klaipėda",
        cardImage: "/assets/images/topics-images/cuisine-topic-img.jpg",
      },
      /*{
        id: "vilnius-new-year-activities",
